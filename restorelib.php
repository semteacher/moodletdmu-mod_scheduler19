<?php //$Id: restorelib.php,v 1.2.10.6 2011/03/15 21:46:17 diml Exp $
    ...
    */
    ...
    function scheduler_restore_mods($mod,$restore) {
        ...
        if ($data) {
            ...
            $scheduler->allowmulticourseappointment = backup_todb($info['MOD']['#']['MULTICOURSEAPPOITMENT']['0']['#']);
    ...
    function scheduler_appointments_restore_mods($old_scheduler_id, $new_scheduler_id, $info, $restore) {
        ...
        for($i = 0; $i < sizeof($appointments); $i++) {
            ...
            //Now, build the SCHEDULER_APPOINTMENT record structure
            $appointment->schedulerid = $new_scheduler_id;

...
$string['allappointments'] = 'Всі призначені зустрічі';
$string['allowgroup'] = 'Exclusive slot - click to change';
$string['allslotsincloseddays'] = 'All slots were in closed days';
$string['allteachersgrading'] = 'Collective grading';
$string['configallteachersgrading'] = 'When enabled, teachers can grade appointmenents they are not assigned to.';
$string['appointagroup'] = 'Групова зустріч';
...
$string['resetting_appointments'] = 'Resetting appointements';
$string['resetting_slots'] = 'Resetting slots';

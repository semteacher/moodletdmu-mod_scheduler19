...
$string['addslot'] = 'Ви можеье будь-коли створити додаткові інтервали прийому.';
...
$string['appointagroup'] = 'Груповий прийом';
...
$string['bookwithteacher'] = 'Реєстратор';
...
$string['guestscantdoanything'] = 'Гості не можуть нічого робити тут.';
...
$string['isnonexclusive'] = 'Цей інтревал був вибраний більше ніж один раз';
$string['lengthbreakdown'] = 'По тривалості інтервалу'; // @DYNA
$string['limited'] = 'Обмежено ($a залишилось)';
$string['location'] = 'Розміщення';
$string['markseen'] = 'будь-ласка, після зустрічі з студентом поставте відмітку \"З\'явився\", поставивши відповідний прапорець в таблиці вище.';
...
$string['missingstudents'] = '$a студентів все ще потребують розкладу на прийом';
$string['mode'] = 'Режим';
...
$string['nostudents'] = 'Намає записаних на прийом студентів';
...
$string['notselected'] = 'и не зробили вибору';
$string['now'] = 'Зараз';
...
$string['oneslotadded'] = '1 інтревал додано';
...
$string['remindertext'] = 'Це нагадування вказує, що Ви не налаштували Ваш графік прийому. Будь-ласка, якщо можливо, виберіть інтревал часу о ';
...
$string['reuseguardtime'] = 'Повторне використання охоронного часу';
$string['revoke'] = 'Анулювати графік прийом';
...
$string['schedulestudents'] = 'Заплановано студентом';
$string['seen'] = 'Зустріч';
...
$string['slotwarning'] = '<b>Попередження: </b>Переміщення цього інтервалу на вибраний час вимагає щоб наступний(і) інтервал(и) був переміщений...';
$string['staffbreakdown'] = 'Ким: $a'; // @DYNA
$string['staffmember'] = 'Професорсько-викладацький склад';
$string['staffrolename'] = 'Назва ролі реєстратора';
$string['start'] = 'Початок';
$string['startpast'] = 'Ви не можете рзпочати інтервал прийому в минулому';
...
$string['xdaysbefore'] = ' днів до інтервалу';
$string['xweeksbefore'] = ' тижнів до інтервалу';

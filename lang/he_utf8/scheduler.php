<?PHP // $Id: by Nadav Kavalechik and Miki Alliel
...
$string['addscheduled'] = 'הוספת שנקבעה לו פגישה';
...
$string['scheduler:attend'] = 'סטודנטים משתתפים'; // @DYNA
...
$string['scheduler:disengage'] = 'ביטול כל המפגשים (עם סטודנטים)'; // @DYNA
$string['scheduler:manage'] = 'ניהול מפגשים ופגישות קיימות'; // @DYNA
$string['scheduler:manageallappointments'] = 'ניהול נתוני מפגשים'; // @DYNA
$string['scheduler:seeotherstudentsbooking'] = 'צפו ברישום למישבצת של סטודנטים אחרים'; // @DYNA
...
$string['studentbreakdown'] = 'על פי סטודנטים'; // @DYNA
